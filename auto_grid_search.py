...
def read_summary(summary_path):
    ...
    with open(summary_path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            elif line.startswith("Test MAE (degC):"):
                result["test_mae_degC"] = float(line.split(":", 1)[1].strip())
            elif line.startswith("Test RMSE (degC):"):
                result["test_rmse_degC"] = float(line.split(":", 1)[1].strip())
            elif line.startswith("Test MSE (degC^2):"):
...
def main():
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            "Rank | TestLoss | ValBest | MAE(degC) | RMSE(degC) | MSE(degC^2) | s1 | w_pde | pde_every | lr | "
